...
Public Class EditHHKContributions
    ...
    Private Sub btnDonation_Click(sender As Object, e As EventArgs) Handles btnDonation.Click
        ...
        Else
            Try
                ...
                command.CommandText = "spUpdateHHKContribution"
                command.Parameters.AddWithValue("@HHKContributionID", tbContributionID.Text.ToString())
    ...
    Private Sub EditHHKContributions_Load(sender As Object, e As EventArgs) Handles MyBase.Load
